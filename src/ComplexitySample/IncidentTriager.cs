...
public static class IncidentTriager
{
    public static string Triage(string? category, int severity, bool customerVisible, bool regulated, int openMinutes)
    {
        ...
        {
            if (string.Equals(category, "OUTAGE", StringComparison.OrdinalIgnoreCase))
            {
                if (severity >= 4)
                {
                    if (customerVisible)
            ...
            else if (string.Equals(category, "SECURITY", StringComparison.OrdinalIgnoreCase))
            {
                if (regulated)
                {
                    if (severity >= 3)
            ...
            else if (string.Equals(category, "DATA", StringComparison.OrdinalIgnoreCase))
            {
