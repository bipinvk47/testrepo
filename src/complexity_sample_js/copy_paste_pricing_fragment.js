/**
 * Dev-only near-duplicate block so duplicate-line metrics differ from other branches (JS twin).
 */

function pricingFragmentMirror(
  customerTier,
  orderTotalCents,
  itemCount,
  isHoliday,
...
module.exports = { pricingFragmentMirror };
