...
/**
 * Near-duplicate of {@link DiscountCalculator} logic to surface code duplication in analysis tools.
 */
public final class TaxCalculator {
    ...
    public static double computeTieredSurcharge(String customerTier, int orderTotalCents, int itemCount,
